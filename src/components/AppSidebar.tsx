...
const mainNavItems: NavItem[] = [{
  ...
  title: "Checklist por Canal",
  href: "/checklist-fechamento",
  icon: ClipboardCheck
}, {
...
const settingsNavItems: NavItem[] = [{
  ...
  title: "Regras Categorização",
  href: "/regras-categorizacao",
  icon: Sparkles
}, {
  title: "Regras Marketplace",
  href: "/regras-marketplace",
  icon: Store
}, {
  title: "Mapeamentos MLB ↔ SKU",
  href: "/mapeamentos-marketplace",
  icon: Link2
}, {
  title: "Usuários",
  href: "/usuarios",
      ...
      <div className="flex items-center justify-between p-4 h-16">
        <div className={cn("flex items-center gap-3 overflow-hidden", collapsed && "justify-center")}>
          <div className="w-10 h-10 rounded-lg bg-primary flex items-center justify-center flex-shrink-0">
            <img alt="Ecom Finance" className="w-8 h-8 object-contain" src="/lovable-uploads/8b500e39-461b-4657-8aad-acb0ee7422e1.png" />
          </div>
