-- Corrigir referência de coluna inexistente em sku_costs (usa sc.sku, não sc.sku_marketplace)

DROP FUNCTION IF EXISTS public.get_vendas_por_pedido(uuid, date, date, text, text, text, text, int, int, text, text);
DROP FUNCTION IF EXISTS get_vendas_por_pedido(uuid, date, date, text, text, text, text, int, int, text, text);
...
DROP FUNCTION IF EXISTS get_vendas_por_pedido_count(uuid, date, date, text, text, text, text, text, text);
...
GRANT EXECUTE ON FUNCTION public.get_vendas_por_pedido(uuid, date, date, text, text, text, text, int, int, text, text) TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_vendas_por_pedido_count(uuid, date, date, text, text, text, text, text, text) TO authenticated;
