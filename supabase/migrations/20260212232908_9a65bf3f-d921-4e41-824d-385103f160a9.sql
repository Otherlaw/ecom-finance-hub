...
-- Fix: get_vendas_por_pedido returns numeric for qtd_itens but declares bigint
-- Cast the aggregated value to bigint to match the declared return type
...
BEGIN
  ...
  agregado AS (
    SELECT
      ...
      -- FIX: Cast to bigint to match declared return type
